...
func (c *emailProviderClient) SendEmail(ctx context.Context, in *SendEmailRequest, opts ...grpc.CallOption) (*SendEmailResponse, error) {
	...
	err := c.cc.Invoke(ctx, EmailProvider_SendEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedEmailProviderServer must be embedded to have
...
func (UnimplementedEmailProviderServer) testEmbeddedByValue()                       {}
...
func RegisterEmailProviderServer(s grpc.ServiceRegistrar, srv EmailProviderServer) {
	// If the following call panics, it indicates UnimplementedEmailProviderServer was
